# -*- coding: utf-8 -*-
"""Industrial_copper_capstone_project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1vw1gBurN4xrsJYTAh4Ku-bFgfsTbW1iA
...
"""##Write the styling factors in streamlit"""
...
new_sample= np.array([[np.log(float(quantity_tons)),application,np.log(float(thickness)),float(width),country,str(customer),int(product_ref),item_type,status]])
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by Rishi Kora</h6>', unsafe_allow_html=True )